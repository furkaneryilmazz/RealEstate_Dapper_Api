...
builder.Services.AddCors(opt =>
{
    ...
    {
        builder.AllowAnyHeader() //Dýþarýdan gelen isteklerde header bilgilerini kontrol etme
        .AllowAnyMethod()   //Dýþarýdan gelen isteklerde method bilgilerini kontrol etme
        .SetIsOriginAllowed((host) => true) //Dýþarýdan gelen isteklerde origin bilgilerini kontrol etme
        .AllowCredentials(); //Dýþarýdan gelen isteklerde credential bilgilerini kontrol etme credential: kimlik bilgisi
    });
});
...
app.UseCors("CorsPolicy"); //CorsPolicy adýnda bir policy tanýmladýk ve bu policy'yi kullan dedik
